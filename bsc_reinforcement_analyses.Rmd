...
# characteristics of roost data
hist(clusters$npoints)

summary(clusters$npoints)

# remove clusters with insufficient points to characterise as a roost
roosts <- subset(clusters, npoints>15)

# thin data to remove synonymous roosts
