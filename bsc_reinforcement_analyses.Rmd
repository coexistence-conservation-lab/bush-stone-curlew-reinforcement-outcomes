...
# Packages
pacman::p_load(amt, atlastools, beepr, ggfortify, ggmap, ggpubr, ggridges, janitor, lme4, lmerTest, move, scattermore, sf, spThin, suncalc, survival, survminer, terra, tidyterra, tidyverse)
...
```{r}
# release coords
release  <- c(274423.45, 5801912.85) #(-37.902374, 144.434323)
```
