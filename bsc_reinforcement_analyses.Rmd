...
We define this as the period from the last reinforcer released (2023-06-11) to the end of the study period (2024-01-10). Each dyad takes approx. 12 seconds so all 378 takes <2 hours to run. 
