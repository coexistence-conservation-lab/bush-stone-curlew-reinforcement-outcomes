...
Compare a three state and four state model with a test subset (Nutmeg in June).
...
anglePar <- c(
  0, 0, 0, 0,      # Means for all states (0 radians, slightly shifted for Traveling/Flying)
...
*4 state model description*

State 1: Resting

  * Step Parameters: Small steps (mean = 7.21 m, sd = 5.64 m) with moderate zero-mass (0.155), indicating brief periods of immobility.
  * Angle Parameters: Slight positive mean (0.117 radians) with low concentration (1.18), suggesting minimal movement and slight shifts in position.
  * VEDBA Influence: The VEDBA coefficient (1.12) suggests that as VEDBA increases, the likelihood of being in this resting state decreases, implying higher activity levels are less likely to correspond with resting.
  * Behavior: Represents periods of rest or low activity, with occasional small adjustments in position. 
  * Transitions to exploring are possible but unlikely (0.1079).

State 2: Exploring

  * Step Parameters: Moderate steps (mean = 93.32 m, sd = 53.80 m) with no zero-mass (0), indicating continuous movement.
  * Angle Parameters: Near-zero mean (0.027 radians) and moderate concentration (2.72), suggesting straightforward movement with slight directional changes.
  * VEDBA Influence: The VEDBA coefficient (6.26) indicates a strong positive relationship between VEDBA and exploring behavior. Higher VEDBA corresponds to increased likelihood of staying in this exploring state, which involves moderate movement.
  * Behavior: Represents active exploration, with directed movement and moderate variability in walking patterns. 
  * Transitioning to traveling (0.33) or foraging (0.12) is common.

State 3: Foraging

  * Step Parameters: Small steps (mean = 28.66 m, sd = 23.17 m) with moderate zero-mass (0.164), indicating some immobility while foraging.
  * Angle Parameters: Negative mean (-0.166 radians) and moderate concentration (1.37), suggesting turning behaviors associated with searching or pecking.
  * VEDBA Influence: The VEDBA coefficient (-1.67) suggests a negative relationship between VEDBA and foraging. As VEDBA increases, the likelihood of being in this state decreases, meaning more active periods with higher body movement (e.g., exploring or traveling) are less likely to align with foraging.
  * Behavior: Represents foraging, with small steps and frequent turning. Transitions to traveling (0.12) are common, while staying in the foraging state (0.85) is highly probable.
  
State 4: Traveling/Flying

  * Step Parameters: Large steps (mean = 253.72 m, sd = 312.95 m) with moderate zero-mass (0.23), indicating potential rest periods during travel.
  * Angle Parameters: Positive mean (0.262 radians) and moderate concentration (1.92), suggesting frequent directional changes during travel or flight.
  * VEDBA Influence: The VEDBA coefficient (1.27) indicates a positive relationship between VEDBA and traveling/flying. As VEDBA increases, the likelihood of staying in this state also increases, reflecting that higher movement (e.g., flight) is strongly associated with this state.
  * Behavior: Represents long-distance movement, likely involving flight. 
  * Transitions to exploring (0.27) or foraging (0.37) are common, while returning to resting (0.05) is unlikely.

Transition Probabilities:

  * State 1 (Resting): Likely transitions to State 2 (Exploring) or stays in resting.
  * State 2 (Exploring): May transition to State 4 (Traveling/Flying) or stay exploring.
  * State 3 (Foraging): Likely stays in foraging or transitions to traveling.
  * State 4 (Traveling/Flying): Likely transitions to exploring or foraging, with low likelihood of returning to resting.

Initial Distribution:
The model starts almost exclusively in State 3 (Foraging) (99.98%), reflecting a strong initial foraging activity


Now try a range of starting values to optimise parameters.
...
Pretty similar outcomes and interpretation to the original model, but states 2 and 3 have swapped positions in the model. Also the step lengths for state 2 are longer. 

This model:
 mbest[["mle"]][["step"]]
           state 1    state 2     state 3     state 4
mean     7.1906287 28.8285146 94.42954804 255.7081955
sd       5.6234347 23.2235980 54.53422724 315.9460045
zeromass 0.1548154  0.1668964  0.01756811   0.2130973

 mbest[["mle"]][["angle"]]
                state 1    state 2    state 3  state 4
mean          0.1107482 -0.1662959 0.01981132 0.275707
concentration 1.1810018  1.3751230 2.70520468 1.925114

Previous model:
 hmm4[["mle"]][["step"]]
          state 1      state 2    state 3     state 4
mean     7.209585 9.332171e+01 28.6620142 253.7168279
sd       5.635077 5.380436e+01 23.1683246 312.9453058
zeromass 0.155442 9.999968e-09  0.1644345   0.2281307
 hmm4[["mle"]][["angle"]]
                state 1    state 2    state 3   state 4
mean          0.1174073 0.02666516 -0.1661067 0.2620442
concentration 1.1832840 2.71779582  1.3708692 1.9180780
