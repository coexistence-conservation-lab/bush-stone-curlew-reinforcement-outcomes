...
Does the addition of the reinforcing cohort change the movement of the residents?
...
Interestingly we can see the original residents had split into two roost areas (zone 2 and central woodland). There was some swapping between these from January to April. In June the residents came together into a single cluster, until the reinforcers arrived and caused an upset in the stability. They then alternate between the central woodland and the eastern boundary (except for Aurora who goes back to zone 2 by themself).
