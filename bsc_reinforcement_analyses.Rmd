...
Percentage original data removed: 13%
...
The highest sampling rates are 11 minutes for Timber and Marmalade, the overall average 6 minutes. Subsampling to 10 minutes.
...
Birds were tracked for a total of 285 days between October 2022 and August 2023 for a total of 3541 tracking days (sum of each bird's tracking duration). 
...
Dates are from the last reinforcer released to the day before the first reinforcer translocated to the secondary site (otherwise includes dates where disturbance took place).
